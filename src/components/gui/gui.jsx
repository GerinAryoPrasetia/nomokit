        ...
        <MediaQuery minWidth={layout.fullSizeMinWidth}>
            {(isFullSize) => {
                ...
                return isPlayerOnly ? (
                    ...
                    // !sessionLogin.hasOwnProperty('user') ? (
                    <LoginModal
                        title="LOGIN"
                        closeLoginModalButtonClick={closeLoginModalButtonClick}
                    />
                ) : (
                    <Box
...
const mapStateToProps = (state) => ({
    ...
    sessionLogin: state.auth.sessionLogin,
});

const mapDispatchToProps = (dispatch) => ({
    changeSessionLogin: (data) => dispatch(changeSessionLogin(data)),
});
